...
import studio.honidot.litsap.databinding.ItemMurmurBinding

class MurmurAdapter(val viewModel: ProfileViewModel) : ListAdapter<Member, MurmurAdapter.ModuleViewHolder>(DiffCallback) {

    class ModuleViewHolder(private var binding: ItemMurmurBinding): RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ModuleViewHolder {
        return ModuleViewHolder(ItemMurmurBinding.inflate(LayoutInflater.from(parent.context), parent, false))
    }
