...
//        onView(withId(R.id.edit_title)).perform(replaceText("ExpressoTest"))
//        Thread.sleep(1500)
...
//    }
    ...
    fun chooseTaskToWorkoutFlow(){
        ...
        onView(withId(R.id.recycler_task)).perform(RecyclerViewActions.actionOnItemAtPosition<TaskAdapter.AssignmentViewHolder>(2,
            click()))
        Thread.sleep(2000)
        onView(withId(R.id.recycler_module_detail)).perform(RecyclerViewActions.actionOnItemAtPosition<TaskAdapter.AssignmentViewHolder>(2,
            click()))
        Thread.sleep(2000)
